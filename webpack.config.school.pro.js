...
console.log('....................生产模式，用于正式环境(C-Life智慧健康校园运营管理平台)......................');

// var commonsChunk = new webpack.optimize.CommonsChunkPlugin('commons','commons.v1.0.[hash:8].js');  // 生成common.js公共代码文件
var commonsChunk = new webpack.optimize.CommonsChunkPlugin('commons','commons.v1.0.9777cf4f.js');
...
var htmlWebpackPlugin = new HtmlWebpackPlugin({
    ...
    author: 'masheng',
    filename: '../index.html',
    template: './school/src/index_pro.ejs',
    // inject: false,
    hash: true,
    minify: {
        minifyCSS: true,
...
var config = {
    ...
    output: {  // 输出文件
        path: path.join(__dirname, '/school/production/build'),
        // filename: '[name].v1.0.[hash:8].js', 
        // chunkFilename: 'chunk.[id].v1.0.[hash:8].js', 
        filename: '[name].v1.0.9777cf4f.js',
        chunkFilename: 'chunk.[id].v1.0.9777cf4f.js',
        publicPath: './build/', 
    },
    module: {  // 资源加载器       
        loaders: [  
